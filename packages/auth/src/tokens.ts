...
// ============================================================================
// PBKDF2 is correct for password-derived secrets. For already-random
// key material (RFC 5869 HKDF) is the right primitive — near-instant,
// no cache needed. The two paths are NOT wire-compatible.
...
/** AES-GCM with an HKDF-derived key. Not wire-compatible with encrypt(). */
