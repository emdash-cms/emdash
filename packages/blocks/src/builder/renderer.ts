...
function renderImage(block: BuilderBlock): string {
  ...
  const props = (block as BuilderBlock & { props?: { src?: string; url?: string; alt?: string; width?: string; alignment?: string } }).props ?? {};
...
function renderButton(block: BuilderBlock): string {
  const props = (block as BuilderBlock & { props?: { text?: string; href?: string; variant?: string; size?: string } }).props ?? {};
...
function renderContainer(block: BuilderBlock): string {
  const props = (block as BuilderBlock & { props?: { background?: string; padding?: string; maxWidth?: string } }).props ?? {};
  const style = [
