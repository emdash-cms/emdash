...
export function injectCoreRoutes(
	...
	injectRoute({
		pattern: "/_emdash/api/admin/transfer/capabilities",
		entrypoint: resolveRoute("api/admin/transfer/capabilities.ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/imports",
		entrypoint: resolveRoute("api/admin/transfer/imports/index.ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/imports/[id]",
		entrypoint: resolveRoute("api/admin/transfer/imports/[id]/index.ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/imports/[id]/missing",
		entrypoint: resolveRoute("api/admin/transfer/imports/[id]/missing.ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/imports/[id]/files/[...path]",
		entrypoint: resolveRoute("api/admin/transfer/imports/[id]/files/[...path].ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/imports/[id]/analyze",
		entrypoint: resolveRoute("api/admin/transfer/imports/[id]/analyze.ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/imports/[id]/plan",
		entrypoint: resolveRoute("api/admin/transfer/imports/[id]/plan.ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/imports/[id]/cancel",
		entrypoint: resolveRoute("api/admin/transfer/imports/[id]/cancel.ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/imports/[id]/abandon",
		entrypoint: resolveRoute("api/admin/transfer/imports/[id]/abandon.ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/imports/[id]/execute",
		entrypoint: resolveRoute("api/admin/transfer/imports/[id]/execute.ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/imports/[id]/advance",
		entrypoint: resolveRoute("api/admin/transfer/imports/[id]/advance.ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/imports/[id]/receipt",
		entrypoint: resolveRoute("api/admin/transfer/imports/[id]/receipt.ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/exports",
		entrypoint: resolveRoute("api/admin/transfer/exports/index.ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/exports/[id]",
		entrypoint: resolveRoute("api/admin/transfer/exports/[id]/index.ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/exports/[id]/advance",
		entrypoint: resolveRoute("api/admin/transfer/exports/[id]/advance.ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/exports/[id]/manifest",
		entrypoint: resolveRoute("api/admin/transfer/exports/[id]/manifest.ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/exports/[id]/files/[...path]",
		entrypoint: resolveRoute("api/admin/transfer/exports/[id]/files/[...path].ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/exports/[id]/archive",
		entrypoint: resolveRoute("api/admin/transfer/exports/[id]/archive.ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/approvals",
		entrypoint: resolveRoute("api/admin/transfer/approvals/index.ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/approvals/[id]/approve",
		entrypoint: resolveRoute("api/admin/transfer/approvals/[id]/approve.ts"),
	});

	injectRoute({
		pattern: "/_emdash/api/admin/transfer/approvals/[id]/deny",
		entrypoint: resolveRoute("api/admin/transfer/approvals/[id]/deny.ts"),
	});
