...
<!-- If any part of this PR was generated by AI tools (Copilot, Claude, GPT, Cursor, etc.), check the box and name the model(s)/tool(s) you used. This is fine — we just need to know so reviewers can pay extra attention to edge cases. -->
