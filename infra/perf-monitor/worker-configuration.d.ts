/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b373960c0de89d912febd07f6843333d)
// Runtime types generated with workerd@1.20260526.1 2026-04-01 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	PROBE_USE: Fetcher /* emdash-perf-probe-use */;
	PROBE_EUW: Fetcher /* emdash-perf-probe-euw */;
	PROBE_APE: Fetcher /* emdash-perf-probe-ape */;
	PROBE_APS: Fetcher /* emdash-perf-probe-aps */;
	PROBE_SAE: Fetcher /* emdash-perf-probe-sae */;
	PROBE_OCE: Fetcher /* emdash-perf-probe-oce */;
}
