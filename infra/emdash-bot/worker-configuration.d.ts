/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=dist/emdash_bot/wrangler.json` (hash: 2cd47a7a9fac0c15271145a1eb5cd986)
// Runtime types generated with workerd@1.20260820.1 2026-07-17 nodejs_compat
interface __BaseEnv_Env {
	BOT_WORKSPACE: R2Bucket;
	LOADER: WorkerLoader;
	AI: Ai;
	...
	GITHUB_REPO: "emdash";
	PREVIEW_PACKAGE: "emdash";
	GITHUB_WEBHOOK_SECRET: string;
	GITHUB_OPERATOR_SECRET: string;
	GITHUB_APP_PRIVATE_KEY: string;
	Sandbox: DurableObjectNamespace<import("./dist/emdash_bot/index").Sandbox>;
	GITHUB_RATE_LIMIT: DurableObjectNamespace<import("./dist/emdash_bot/index").GitHubRateLimitDO>;
	Orchestrator: DurableObjectNamespace<import("./dist/emdash_bot/index").OrchestratorDO>;
	FLUE_CLASSIFY_COMMAND_AGENT: DurableObjectNamespace<import("./dist/emdash_bot/index").FlueClassifyCommandAgent>;
	FLUE_INVESTIGATE_AGENT: DurableObjectNamespace<import("./dist/emdash_bot/index").FlueInvestigateAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/emdash_bot/index");
		durableNamespaces: "Sandbox" | "OrchestratorDO" | "FlueClassifyCommandAgent" | "FlueInvestigateAgent" | "GitHubRateLimitDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_APP_ID" | "GITHUB_APP_INSTALLATION_ID" | "GITHUB_OWNER" | "GITHUB_REPO" | "PREVIEW_PACKAGE" | "GITHUB_WEBHOOK_SECRET" | "GITHUB_OPERATOR_SECRET" | "GITHUB_APP_PRIVATE_KEY">> {}
}
