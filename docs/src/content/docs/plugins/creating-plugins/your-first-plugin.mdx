...
- **`entrypoint` is a module specifier**, not a file path. Use the same string you'd pass to `import` — usually `"<package-name>/sandbox"`.
- **`id` should match the npm package name.** It's how EmDash scopes storage, KV, and route URLs.
