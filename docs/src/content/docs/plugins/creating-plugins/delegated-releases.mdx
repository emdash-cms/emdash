...
<Aside type="caution" title="Experimental">
	...
	GitHub's public Sigstore root. [RFC 0001](https://github.com/emdash-cms/emdash/pull/694)
	governs the experimental registry protocol.
</Aside>
...
4. Open the [release-service dashboard](https://emdash-release-service.emdash-cms.workers.dev/publisher) and sign in with the same Atmosphere account.
