...
The admin helpers do not render React. Use the [Block Playground](https://blocks.emdashcms.com/) or a browser journey to verify Kumo rendering, confirmation dialogs, keyboard operation, and right-to-left layout.
