...
After deployment, open **Settings > AI Search** in the EmDash admin panel to choose which collections to index and monitor indexing progress. New and updated published content is kept in sync automatically.
