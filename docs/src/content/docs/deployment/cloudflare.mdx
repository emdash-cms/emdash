...
and stores the key but does not yet use it — plugin secret encryption
is rolling out and will start using this value automatically when
available. Set it now so your deployment is ready.
