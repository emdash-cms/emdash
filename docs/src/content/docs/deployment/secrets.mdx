...
| [CLI credentials](#cli-and-publishing-credentials) | `emdash login` device flow        | `~/.config/emdash/auth.json` (mode 0600) | Run `emdash login` again                        |
...
## CLI and publishing credentials
