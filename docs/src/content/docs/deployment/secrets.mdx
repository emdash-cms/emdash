...
| [OAuth provider credentials](#user-provided-service-credentials) | You (Google, GitHub, or Microsoft Entra console) | Environment                         | Sign-in via that provider stops until replaced  |
...
| Microsoft sign-in      | `EMDASH_OAUTH_MICROSOFT_CLIENT_ID`, `EMDASH_OAUTH_MICROSOFT_CLIENT_SECRET`, `EMDASH_OAUTH_MICROSOFT_TENANT_ID` (or unprefixed aliases) |
