...
- collections, fields, taxonomy definitions, relation definitions, and byline field definitions;
...
- **No content.** The target must not hold entries (including trashed entries), revisions, media or media folders, bylines or byline fields, comments, redirects, term assignments, relations, SEO records, sections created in the admin, or collections created after setup. A site set up from any official template qualifies. What setup created is setup scaffold: the seeded collections, taxonomy definitions and their unassigned terms, menus and their items, widget areas and their widgets, and theme sections. The plan lists the scaffold, and the import removes it after you confirm the plan.
...
| `dangling_reference` | A record refers to a record that is not in the package. |
...
3. Create collections, fields, taxonomy definitions, relation definitions, and byline fields.
