...
For a published entry with revisions enabled, assigning or removing terms saves a draft. Select **Publish changes** to make the new terms visible to visitors, or **Discard changes** to keep the published terms. Entries in collections without revisions update their terms immediately.
