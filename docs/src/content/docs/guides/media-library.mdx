...
The setup wizard selects **Track where media is used** by default for new sites. Clear that option to leave it off.

If media usage tracking is off after setup, an administrator can turn it on:
