...
Administrators see a setup notice until Media Usage is enabled. Open **Settings → Media Usage**, select **Enable Media Usage**, then select **Turn on**. Indexing continues in the background if you leave the page, and the Settings page shows its progress.
