...
EmDash JSON backups are portable exports of selected data. They are useful for inspection and retention, but EmDash cannot import them. A recovery plan needs a restorable database backup and a separate copy of media binaries.
