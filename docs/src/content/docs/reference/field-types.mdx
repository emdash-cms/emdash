...
In the admin UI, JSON fields render as an auto-formatting textarea. Existing values load pretty-printed, and valid JSON is reformatted as you edit so nested objects stay readable.
