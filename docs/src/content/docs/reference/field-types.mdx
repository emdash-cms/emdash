...
In the admin UI, JSON fields render as an auto-formatting editor with a syntax-highlighted preview. Existing values load pretty-printed, valid JSON is reformatted as you edit, and invalid JSON blocks saving until it is fixed.
