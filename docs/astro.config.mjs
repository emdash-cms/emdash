			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: "Building Plugins", slug: "plugins/getting-started" },
						{ label: "Creating Plugins", slug: "plugins/creating-plugins" },
						{ label: "Plugin Hooks", slug: "plugins/hooks" },
						{ label: "Capabilities", slug: "plugins/capabilities" },
						...
						{ label: "Publishing to Marketplace", slug: "plugins/publishing" },
