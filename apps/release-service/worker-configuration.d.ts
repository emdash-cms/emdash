...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "ALLOWED_ORIGINS" | "ALLOWED_PUBLISHERS" | "DEPLOYMENT_POLICY" | "ENCRYPTION_KEYRING">> {}
}
