/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6d972405f92f5912a07f4c6911999ab0)
// Runtime types generated with workerd@1.20260815.1 2026-05-14 nodejs_compat
interface __BaseEnv_Env {
	PUBLICATION_STAGING: R2Bucket;
	OPERATIONS_ARCHIVE: R2Bucket;
	OPERATIONS_METRICS: AnalyticsEngineDataset;
	ASSETS: Fetcher;
	PUBLIC_ORIGIN: "https://emdash-release-service.emdash-cms.workers.dev";
	DEPLOYMENT_ID: "emdash-release-service-production";
	ACCESS_TEAM_DOMAIN: "https://cf-emdash-cms.cloudflareaccess.com";
	ACCESS_VIEWER_AUD: "9e94dcee531107093096e1aff1a1fe7df68f93fc599c1ee8282ed76d70fd568c";
	ACCESS_REVIEWER_AUD: "b282de16228e3c42a0aa41d3aba8478d79d1987e37a7b5778f628552581ad8f6";
	ACCESS_ADMIN_AUD: "[\"a53a97932d4d07decf44e727abfe0c1c9d85412c62b5e55669148d5d2296338c\",\"1a4f3f6eba0fb3c3cdfcc3f77f6e5f4a0e4af2e0f7efe31ef12fb077e7cccc64\",\"54c4eec8766ebf5ade4c9e9c95cd8e2cadfcf441850bb56f34bfe097acd68ac0\",\"4a68acabdd10af19b45d7d6bf6623aa7a18b4407999f0b769b3371ab256c292f\"]";
	OAUTH_REDIRECT_URIS: "[\"https://emdash-release-service.emdash-cms.workers.dev/oauth/callback\"]";
	OAUTH_ASSERTION_KEYSET: string;
	ENCRYPTION_KEYRING: string;
	IDENTITY_DIRECTORY_DO: DurableObjectNamespace<import("./src/index").IdentityDirectoryDurableObject>;
	APPROVER_DO: DurableObjectNamespace<import("./src/index").ApproverDurableObject>;
	OAUTH_STATE_DO: DurableObjectNamespace<import("./src/index").OAuthStateDurableObject>;
	...
	PUBLISHER_ARCHIVE_WORKFLOW: Workflow<Parameters<import("./src/index").PublisherArchiveWorkflow['run']>[0]['payload']>;
	ENCRYPTION_VERIFICATION_WORKFLOW: Workflow<Parameters<import("./src/index").EncryptionVerificationWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ApproverDurableObject" | "IdentityDirectoryDurableObject" | "OAuthStateDurableObject" | "PublisherDurableObject" | "ServiceControlDurableObject";
	}
