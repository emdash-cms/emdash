/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../release-verifier/wrangler.jsonc` (hash: b073fd522e48557982a702d20b1f3d23)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "ALLOWED_ORIGINS" | "ALLOWED_PUBLISHERS" | "DEPLOYMENT_POLICY" | "OAUTH_REDIRECT_URIS" | "ENCRYPTION_KEYRING" | "OAUTH_ASSERTION_KEYSET">> {}
}
