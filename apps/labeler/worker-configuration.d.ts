/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 490b7dad8be5c210c0f8b01eb3159e34)
// Runtime types generated with workerd@1.20260815.1 2026-08-24 nodejs_compat
interface __BaseEnv_Env {
	MEDIA_QUARANTINE: R2Bucket;
	EVAL_DATASETS: R2Bucket;
	...
	LABEL_SIGNING_PUBLIC_KEY: "REPLACE_WITH_PRODUCTION_P256_MULTIKEY";
	...
	OPERATOR_ACCESS_CONFIG: "{\"teamDomain\":\"https://emdash.cloudflareaccess.com\",\"audience\":\"REPLACE_WITH_ACCESS_APP_AUDIENCE\",\"admins\":[\"emdash-labeler-admins\"],\"reviewers\":[\"emdash-labeler-reviewers\"]}";
	EVAL_TEXT_CONFIGURED_UNITS: "1";
	EVAL_IMAGE_CONFIGURED_UNITS: "1";
	LABEL_SIGNING_PRIVATE_KEY: string;
	RECONCILIATION_TOKEN: string;
	LABEL_SUBSCRIPTION_DO: DurableObjectNamespace<import("./src/index").LabelSubscriptionDO>;
	LABELER_DISCOVERY_DO: DurableObjectNamespace<import("./src/index").LabelerDiscoveryDO>;
	AGGREGATOR_RECONCILIATION: Fetcher /* emdash-aggregator */;
	ASSESSMENT_WORKFLOW: Workflow<Parameters<import("./src/index").AssessmentWorkflow['run']>[0]['payload']>;
	LIVE_EVALUATION_WORKFLOW: Workflow<Parameters<import("./src/index").LiveEvaluationWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LabelSubscriptionDO" | "LabelerDiscoveryDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LABELER_DID" | "LABELER_SERVICE_URL" | "LABEL_SIGNING_PUBLIC_KEY" | "LABELER_POLICY_VERSION" | "LABELER_PARSER_VERSION" | "LABELER_TEXT_MODEL_ID" | "LABELER_TEXT_PROMPT_HASH" | "LABELER_IMAGE_MODEL_ID" | "LABELER_IMAGE_PROMPT_HASH" | "JETSTREAM_URL" | "OPERATOR_ACCESS_CONFIG" | "EVAL_TEXT_CONFIGURED_UNITS" | "EVAL_IMAGE_CONFIGURED_UNITS" | "LABEL_SIGNING_PRIVATE_KEY" | "RECONCILIATION_TOKEN">> {}
}
